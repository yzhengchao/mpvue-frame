...
function request(url) {
    ...
    var header = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : "application/x-www-form-urlencoded";
            ...
            success: function success(res) {
                ...
                if (res.statusCode == 200) {
                    ...
                    if (res.data.errno == 401) {
                        ...
                        // 带有参数
                        var paramsUrl = getCurrentPageUrlWithArgs();
...
"use strict";
var root = '/api/';
var tra = "http://tracenet.nat300.top/platform";
var test = "http://39.108.244.179:8080/platform";
var product = "https://app.kangjiayiju.com/platform";
var API_BASE_URL = product + root;
var api = {
